...
const Navbar = ({ menu }) => {
  ...
  return (
    <li className="w-full px-5 py-2 list-none font-medium hover:bg-amber-50">
      <Link
        href={menu.route}
        className={` ${
          isActive ? "text-red-500 underline " : ""
        } block relative py-2 px-5 md:p-0 text-gray-900 rounded-sm border-b border-gray-100 hover:bg-gray-50 lg:hover:bg-transparent lg:border-0 `}
        onMouseEnter={() => {
